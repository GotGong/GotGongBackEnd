...
class Plan(models.Model):
    ...
    content = models.TextField(null=True) # 계획 전체 요약
    success_percent = models.FloatField(default=0.0) # 전체 계획 달성률
    ...
    plan_status = models.BooleanField(default=True) # 수행 마감 지났는지 안지났는지 상태
    week = models.IntegerField(default=1) # 주차 (몇주차인지)
...
class DetailPlan(models.Model):
    ...
    content = models.TextField(null=True) # 세부 계획 내용
